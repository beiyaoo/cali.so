...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://beiyaoo.top/favicons/zolplay.png',
  '(?:github.com)': 'https://beiyaoo.top/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://beiyaoo.top/favicons/twitter.png',
  'coolshell.cn': 'https://beiyaoo.top/favicons/coolshell.png',
  'vercel.com': 'https://beiyaoo.top/favicons/vercel.png',
  'nextjs.org': 'https://beiyaoo.top/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://beiyaoo.top/favicon_blank.png'
